              ...
              child: Stack(
                ...
                children: [
                  ...
                  Transform.translate(
                    ...
                    child:
                        Icon(Icons.search, color: Colors.blue[800], size: 15),
                  ),
                ],
              ),
            ),
...
class _InternshipProfilePageState extends State<InternshipProfilePage> {
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton.icon(
                      icon: const Icon(Icons.add),
                      label: const Text('Add Project' ,  style: TextStyle(
                        color:
                            Colors.white, // Change this to any color you want
                        fontWeight: FontWeight.bold,
                      ),),
  ...
  void _showEditEducationDialog(
    ...
    final TextEditingController yearController =
        TextEditingController(text: education.completionYear);
    final TextEditingController performanceController =
        TextEditingController(text: education.performance);
